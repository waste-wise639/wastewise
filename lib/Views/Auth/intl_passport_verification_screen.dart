...
class InternationalPassportVerificationScreen extends StatefulWidget {
  const InternationalPassportVerificationScreen({super.key});

  @override
  State<InternationalPassportVerificationScreen> createState() =>
      _InternationalPassportVerificationScreenState();
}

class _InternationalPassportVerificationScreenState
    extends State<InternationalPassportVerificationScreen> {
  @override
