...
import 'package:wastewise/Views/Auth/WasteVendor/new_vendor_pwd.dart';

class ForgotVendorPwdOtpScreen extends StatefulWidget {
  const ForgotVendorPwdOtpScreen({super.key});

  @override
  State<ForgotVendorPwdOtpScreen> createState() =>
      _ForgotVendorPwdOtpScreenState();
}

class _ForgotVendorPwdOtpScreenState extends State<ForgotVendorPwdOtpScreen> {
  @override
          ...
          child: Column(
            children: [
              ...
              GenBtn(
                ...
                borderRadius: 30,
                tap: () {
                  goTo(context, EnterNewVendorPwdScreen());
                },
              ),
              Height(h: 2),
            ],
