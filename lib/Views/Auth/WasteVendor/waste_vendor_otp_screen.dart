...
import 'package:wastewise/Views/Auth/WasteVendor/vendor_profile_setup.dart';

class WasteVendorOtpVerificationScreen extends StatefulWidget {
  const WasteVendorOtpVerificationScreen({super.key});

  @override
  State<WasteVendorOtpVerificationScreen> createState() =>
      _WasteVendorOtpVerificationScreenState();
}

class _WasteVendorOtpVerificationScreenState
    extends State<WasteVendorOtpVerificationScreen> {
  @override
          ...
          child: Column(
            children: [
              ...
              GenBtn(
                ...
                borderRadius: 30,
                tap: () {
                  goTo(context, VendorProfileSetup());
                },
              ),
              Height(h: 2),
            ],
