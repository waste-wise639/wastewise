...
import 'package:wastewise/Views/Auth/WasteVendor/forgot_vendor_pwd.dart';

class EnterVendorForgotPwdEmail extends StatefulWidget {
  const EnterVendorForgotPwdEmail({super.key});

  @override
  State<EnterVendorForgotPwdEmail> createState() =>
      _EnterVendorForgotPwdEmailState();
}

class _EnterVendorForgotPwdEmailState extends State<EnterVendorForgotPwdEmail> {
  @override
          ...
          child: Column(
            children: [
              ...
              GenBtn(
                ...
                borderRadius: 30,
                tap: () {
                  goTo(context, ForgotVendorPwdOtpScreen());
                },
              ),
              Height(h: 2),
            ],
