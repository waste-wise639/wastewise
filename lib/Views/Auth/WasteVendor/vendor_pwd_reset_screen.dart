...
class VendorPwdResetSuccessScreen extends StatefulWidget {
  const VendorPwdResetSuccessScreen({super.key});

  @override
  State<VendorPwdResetSuccessScreen> createState() =>
      _VendorPwdResetSuccessScreenState();
}

class _VendorPwdResetSuccessScreenState
    extends State<VendorPwdResetSuccessScreen> {
  @override
