...
import 'package:wastewise/Views/Auth/WasteVendor/vendor_pwd_reset_screen.dart';

class EnterNewVendorPwdScreen extends StatefulWidget {
  const EnterNewVendorPwdScreen({super.key});

  @override
  State<EnterNewVendorPwdScreen> createState() =>
      _EnterNewVendorPwdScreenState();
}

class _EnterNewVendorPwdScreenState extends State<EnterNewVendorPwdScreen> {
  @override
          ...
          child: Column(
            children: [
              ...
              GenBtn(
                ...
                borderRadius: 30,
                tap: () {
                  goTo(context, VendorPwdResetSuccessScreen());
                },
              ),
              Height(h: 2),
            ],
