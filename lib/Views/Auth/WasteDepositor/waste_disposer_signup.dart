...
class WasteDisposerSignupScreen extends StatefulWidget {
  const WasteDisposerSignupScreen({super.key});

  @override
  State<WasteDisposerSignupScreen> createState() =>
      _WasteDisposerSignupScreenState();
}

class _WasteDisposerSignupScreenState extends State<WasteDisposerSignupScreen> {
  @override
          ...
          child: Column(
            children: [
              ...
              GenBtn(
                ...
                borderRadius: 30,
                tap: () {
                  goTo(context, OtpVerificationScreen());
                },
              ),
              Height(h: 2),
              GenBtnWE(
