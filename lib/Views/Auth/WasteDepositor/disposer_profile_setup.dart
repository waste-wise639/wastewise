...
class DisposerProfileSetup extends StatefulWidget {
  const DisposerProfileSetup({super.key});

  @override
  State<DisposerProfileSetup> createState() => _DisposerProfileSetupState();
}

class _DisposerProfileSetupState extends State<DisposerProfileSetup> {
  @override
        ...
        child: Column(
          children: [
            ...
            GenBtn(
              ...
              borderRadius: 30,
              tap: () {
                goTo(context, AccountCreatedScreen());
              },
            ),
            Height(h: 2),
          ],
